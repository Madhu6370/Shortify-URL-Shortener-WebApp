...
const Footer = () => {
  return (
    <footer className="bg-gray-200 text-black py-6 z-40 relative">
      <div className="container mx-auto px-6 lg:px-14 flex flex-col lg:flex-row lg:justify-between items-center gap-4">
        ...
        <div className="flex space-x-6 mt-4 lg:mt-0">
          <a href="https://www.linkedin.com/in/madhusmita-das-200312bcd" target="_blank" rel="noopener noreferrer">
            <FaLinkedin size={24} />
          </a>
          <a href="#" >
            <FaFacebook size={24} />
