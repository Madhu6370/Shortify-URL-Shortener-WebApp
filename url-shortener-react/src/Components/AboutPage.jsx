    ...
    <div className="lg:px-14 sm:px-8 px-5 min-h-[calc(100vh-64px)] pt-2">
      <div className="bg-white w-full sm:py-10 py-8  ">
        ...
        <p className="text-gray-700 text-sm  mb-8 xl:w-[60%] lg:w-[70%] sm:w-[80%] w-full ">
          Shortify is a fast and simple URL shortener that lets you convert long links into short, easy-to-share URLs. It allows you to track the number of clicks each short link receives. The platform offers a clean interface and is beginner-friendly. You can explore its features using a guest login without creating an account. Guest URLs are public, so for private link management, sign up or log in. Perfect for anyone who needs quick link sharing with basic analytics.
