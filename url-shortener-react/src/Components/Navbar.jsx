...
const Navbar = () => {
  ...
  return (
  <div className="h-16 bg-blue-400 shadow-md z-50 flex items-center top-0">
      <div className="lg:px-14 sm:px-8 px-4 w-full flex justify-between">
        ...
        <ul
          ...
          }  transition-all duration-100 sm:h-fit sm:bg-none  bg-blue-400 sm:w-fit w-full sm:flex-row flex-col px-4 sm:px-0`}
        >
