  ...
  return (
    ...
    <form
      ...
      >
        ...
        <hr className="mt-2 sm:mb-5 mb-3 text-slate-300" />
        ...
        <button
          className="bg-customRed font-semibold text-white w-32 bg-blue-400  py-2  transition-colors rounded-md my-3 cursor-pointer"
          type="text"
        >
